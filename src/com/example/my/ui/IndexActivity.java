...
import com.example.my.entity.IndexGalleryItemData;
import com.example.my.grally.IndexGalleryAdapter;
import com.example.my.ui.base.BaseActivity;
import com.example.my.utils.CommonTools;
import com.example.my.widgets.HomeSearchBarPopupWindow;
import com.example.my.widgets.HomeSearchBarPopupWindow.onSearchBarItemClickListener;
import com.example.my.widgets.jazzviewpager.JazzyViewPager;
import com.example.my.widgets.jazzviewpager.OutlineContainer;
import com.example.my.widgets.jazzviewpager.JazzyViewPager.TransitionEffect;
import com.example.my.zxing.CaptureActivity;
...
public class IndexActivity extends BaseActivity implements OnClickListener,
	...
	private ImageView mMiaoShaImage ;
	private ImageButton  index_order_btn,index_groupbuy_btn,index_recharge_btn,index_lottery_btn;
	...
	private OnClickListener indexClickListener=new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.index_recharge_btn:
				mIntent=new Intent(IndexActivity.this,RechangeActivity.class);
				startActivity(mIntent);
				break;
			case R.id.index_lottery_btn:
				mIntent=new Intent(IndexActivity.this,LotteryActivity.class);
				startActivity(mIntent);
				break;
			case R.id.index_order_btn:
				mIntent=new Intent(IndexActivity.this,DeliveryActivity.class);
				startActivity(mIntent);
				break;
			case R.id.index_groupbuy_btn:
				mIntent=new Intent(IndexActivity.this,TuanActivity.class);
				startActivity(mIntent);
				break;			
			}		
		}
