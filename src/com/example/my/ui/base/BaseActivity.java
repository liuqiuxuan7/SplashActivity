package com.example.my.ui.base;
...
import com.example.my.AppManager;
import com.example.my.R;
import com.example.my.config.Constants;
import com.example.my.image.ImageLoaderConfig;
import com.example.my.task.AsyncCallable;
import com.example.my.task.Callback;
import com.example.my.task.EMobileTask;
import com.example.my.task.ProgressCallable;
...
//獲得設備信息
 ...
 protected String getCountry() {
	...
	protected <T> void doAsync(final int pTitleResID, final int pMessageResID, final Callable<T> pCallable, final Callback<T> pCallback, final Callback<Exception> pExceptionCallback) {
		com.example.my.task.EMobileTask.doAsync(this, pTitleResID, pMessageResID, pCallable, pCallback, pExceptionCallback);
	}
